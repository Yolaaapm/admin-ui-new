    ...
    <>
      ...
      <div className="mt-16">
        <form action="">
          ...
          {/* 2. Input Email (Sama seperti Sign In) */}
          <div className="mb-6">
            <LabeledInput 
              label="Email Address"
              id="email"
          ...
          {/* 3. Input Password (Sama seperti Sign In) */}
          <div className="mb-6">
            <LabeledInput 
              label="Password"
              id="password"
      ...
      {/* Teks "or sign up with" start (Sama seperti Sign In) */}
      ...
      {/* Sign Up with Google start (Sama seperti Sign In, tapi teks disesuaikan) */}
      <div className="mb-8">
